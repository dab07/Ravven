...
import '../css/Login.css'; // Using the same CSS for consistency
    ...
    return (
        <form className="form">
            ...
            <div className="field">
                <svg className="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    <path
                        d="M10 5a1 1 0 1 0-2 0v4a1 1 0 1 0 2 0V5z"></path>
                    <path
                        d="M5 8a5 5 0 1 1 10 0 5 5 0 0 1-10 0zm9-3a4 4 0 1 0-8 0 4 4 0 0 0 8 0z"></path>
                </svg>
                <input
                    className="input-field"
