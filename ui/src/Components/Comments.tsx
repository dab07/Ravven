...
const Comments = ({postId, initialComments = [], onCommentAdded} : CommentSectionProps) => {
    ...
    // Handle clicks outside comments area
    useEffect(() => {
    ...
    return (
        <div>
            <button className="bookmarkBtn" onClick={toggleComments}>
              <span className="IconContainer">
               <svg fill="white" viewBox="0 0 512 512" height="1em"><path
                ...
                <p className="text">{comments.length}</p>
            </button>
